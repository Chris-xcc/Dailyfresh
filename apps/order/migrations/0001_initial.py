# Generated by Django 2.2 on 2020-06-02 09:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.SmallIntegerField(choices=[(1, '待支付'), (2, '待发货'), (3, '待评价'), (4, '已完成')], default=1, verbose_name='订单状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='order.OrderInfo', verbose_name='订单')),
