...
class OrderGoods(BaseModel):
    # 订单商品模型类
    order = models.ForeignKey('OrderInfo', on_delete=models.DO_NOTHING, verbose_name='订单')
    sku = models.ForeignKey('goods.GoodsSKU', on_delete=models.DO_NOTHING, verbose_name='商品SKU')
